...
public class GameScreen {
    ...
    // przechowuje elementy tła mapy
    private CanvasElement[][] background;
    ...
    public GameScreen() {
        ...
        this.background = new CanvasElement[Constants.numberOfTiles][Constants.numberOfTiles];
            ...
            for (int i = 0; i < Constants.numberOfTiles; i++) {
                for (int j = 0; j < Constants.numberOfTiles; j++) {
                    ...
                    if ((i + j) % 2 == 0) {
                        ...
                        background[i][j] = temp1;
                    }

                }
            }
            this.elementUnderCursor = background[0][0];
